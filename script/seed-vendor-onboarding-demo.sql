...
-- fixed IDs before inserting fresh ones (template_fields/validation_rules/transformations/
-- upload_formats all cascade off templates.template_id).
--
...
VALUES
  ...
  ('tmpl-seed-vendor-onboarding', 'phone_number',
   '[{"from":"0","to":"+91"}]'::jsonb,
   2),
  ('tmpl-seed-vendor-onboarding', 'gst_number',
